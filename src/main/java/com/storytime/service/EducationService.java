...
import com.storytime.repository.GenerationParametersMapper;
import com.storytime.repository.MathExerciseMapper;
...
public class EducationService {
    ...
    @Value("${storytime.demo.image-url:/demo/demo.png}")
